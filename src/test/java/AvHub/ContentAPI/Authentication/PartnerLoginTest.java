...
public class PartnerLoginTest extends BaseTest {
    private static String currentClass = PartnerLoginTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Authenticate Partner. Verify status code.")
    public void partnerLoginTest(String stepData) {
