...
public class DocumentsByPublishedDateTest extends BaseTest {
    private static String currentClass = DocumentsByPublishedDateTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Get Documents by manufacturer, model, Issue Number and optionally Published Date Range. Verify status code.")
    public void documentsByPublishedDateTest(String stepData) {
