...
public class EventsByEffectiveDateTest extends BaseTest {
    private static String currentClass = EventsByEffectiveDateTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Get events by manufacturer, model, and optionally Event Type (AD or SB) and Effective Date Range. Verify status code.")
    public void eventsByEffectiveDateTest(String stepData) {
