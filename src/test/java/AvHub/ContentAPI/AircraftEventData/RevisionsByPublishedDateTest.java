...
public class RevisionsByPublishedDateTest extends BaseTest {
    private static String currentClass = RevisionsByPublishedDateTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Get Revisions by Manufacturer, Model, and optionally Event Type (AD or SB) and Published Date Range. Verify status code.")
    public void revisionsByPublishedDateTest(String stepData) {
