...
public class IsLicensedTest extends BaseTest {
    private static String currentClass = IsLicensedTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Check whether the customer is licensed to access data for the given manufacturer and model. Verify status code.")
    public void isLicensedTest(String stepData) {
