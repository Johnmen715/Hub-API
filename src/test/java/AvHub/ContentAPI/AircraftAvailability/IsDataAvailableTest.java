package AvHub.ContentAPI.AircraftAvailability;
...
public class IsDataAvailableTest extends BaseTest {
    private static String currentClass = IsDataAvailableTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Check whether event data for given manufacturer and model exists based on the customer's content licenses. Verify status code.")
    public void isDataAvailableTest(String stepData) {
