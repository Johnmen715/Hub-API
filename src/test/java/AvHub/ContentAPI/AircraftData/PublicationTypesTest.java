...
public class PublicationTypesTest extends BaseTest {
    private static String currentClass = PublicationTypesTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Get Publication Types by Manufacturer and Model. Verify status code.")
    public void publicationTypesTest(String stepData) {
