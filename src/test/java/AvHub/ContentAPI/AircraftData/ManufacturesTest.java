...
public class ManufacturesTest extends BaseTest {
    private static String currentClass = ManufacturesTest.class.getName();
    ...
    @Test(dataProvider = "testData",
            description = "Get Manufacturers by Component Category. Verify status code.")
    public void manufacturesTest(String stepData) {
